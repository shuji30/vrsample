...
export const LINES = {
  ...
  /** パットパットゴルフ：来る / 番 / 入った / ホールインワン / おしい / 次のホール / 勝ち負け / もう一度 */
  golfInvite: ['パターゴルフ！やるやる！', 'まってー、わたしもやる！'],
  golfYourTurn: ['あなたのばんだよ', 'どうぞー'],
  golfMyTurn: ['つぎ、わたし！', 'いくよー'],
  golfPlayerIn: ['ナイスイン！', 'はいったー！', 'じょうず！'],
  golfPlayerAce: ['ホールインワン！すごーい！'],
  golfGirlIn: ['はいった！やったー！', 'えへへ、はいった！'],
  golfGirlAce: ['ホールインワン！みてたー？'],
  golfClose: ['おしい！', 'あとちょっと！'],
  golfNext: ['つぎのホールいこ！', 'つぎ、いこいこ！'],
  golfWin: ['わたしのかちー！', 'やったー、かっちゃった！'],
  golfLose: ['まけちゃった…じょうずだね！', 'くやしいー！'],
  golfDraw: ['ひきわけだね！'],
  golfAgain: ['もういっかい、まわろ？'],
  ...
  ferrisFun: ['おうち、ちいさくみえるね', 'かぜ、きもちいいね', 'ふたりきりだね', 'ちょっとこわいかも', 'うしろ、うみきれい？', 'ゆっくりで、いいね', 'ジェットコースター、あそこにみえるよ'],
  /** 乗馬：引きにいく / 見にいく / 引き馬を始める / 引きながら / 放す / 急かされて放す / 速歩 / 駈歩 / 止まる / 応援 */
  horseInvite: ['うまにのるの？わたしものせてー！', 'まっててね、いまいくね！'],
  /** 二人乗り：乗るとき / 乗った / 走っているあいだ / 止まっているあいだ / 降りるとき */
  horseMount: ['よいしょっと…', 'まえ、すわるね'],
  horseRideStart: ['ふたりのりだね！', 'しっかりつかまってるね。いこっ！'],
  horseTandem: ['たかくて、けしきがいいね', 'ぱかぱか、たのしいね', 'かぜがきもちいい！', 'このまま、おかのうえまでいこ？'],
  horseTandemStop: ['うま、あったかいね', 'つぎはどこいく？', 'もっとはやくはしれる？'],
  horseDismount: ['たのしかった！', 'ありがとう、うまさん'],
