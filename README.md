...
| 女の子の声を替える | — | V キー |
| 説明を閉じる / 開く | — | × / 「？ 説明」、I キー |
| カートに乗る / 降りる | カートに向けてトリガー / グリップを 0.5 秒 | クリックか近くで E / E |
| カートを運転する | 両手でハンドルを握る形で傾ける、右トリガー アクセル、左トリガー ブレーキ | W S A D（↑↓←→）、C で視点 |
...
- 追い上げ：女の子は、前に離れているほどゆっくり、後ろに離れているほど速く走ります。
  すぐ後ろに追いつくと、横へ出て抜きにかかります
...
- **ハンコンのボタン**：「乗る / 降りる」「視点」「設定の画面」を、ハンコンのボタンに割り当てられます
  （「覚える」を押してからボタンを押す）
