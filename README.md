...
| ラケットを振る | そのまま腕を振る | スペースを押して振りかぶり、離して振る |
...
- ラケットを持ってコートに入ると、女の子もコートへ来ます（下の「女の子とテニス」）

### 女の子とテニス

プレイヤーがラケットを持ってコートに入ると、女の子もキャッチボールをやめてコートへ来て、
...
- ラケットを置く（コートを出る）と、ラケットを元の場所へ戻し、ネットの脇を回ってキャッチボールに戻ります
